...
<body class="theme-red">
  ...
  <!-- Top Bar -->
	...
	<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-0 mb-1 unselectable">
		<div class="collapse mb-2 mb-md-0 show" id="userinfotop">
		   <div class=" row ml-1 align-self-center">
			   <div class="image">
					<img src="assets/img/user.png" alt="User" width="30px" height="30px">
				</div>
				<div class="name pr-2 pt-2 pl-0 text-white"><?php echo $_SESSION['username']; ?></div>
				<!--<div class="email pr-2 pt-2 text-white-50">Last Login: <?php //echo date('d-m-y h:i a', time()); ?> </div> 
        ...
        <div class="collapse navbar-collapse unselectable" id="navbarCollapse">
            <!--<div class="navbar-nav ml-auto">
				...
				<div class="nav-item dropdown">
					<a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Mail</a>
					<div class="dropdown-menu">
						<a href="#" class="dropdown-item">gmail</a>
						<a href="#" class="dropdown-item">yahoo</a>
						<a href="#" class="dropdown-item">hotmail</a>
					</div>
				</div>
				<a href="coding/logout.php?logout" class="name" style="text-decoration: none !important;">Logout</a>
